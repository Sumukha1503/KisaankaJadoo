        ...
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center font-bold text-gray-500">{t('loading')}</div>}>
            <div className="min-h-screen bg-white">
                    <Routes>
                        ...
                        <Route path="/analytics" element={<PrivateRoute roles={['FARMER', 'ADMIN']}><AnalyticsPage /></PrivateRoute>} />
                        ...
                        <Route path="/assistant" element={<PrivateRoute roles={['FARMER', 'ADMIN', 'LABOUR']}><AssistantPage /></PrivateRoute>} />
